...
END IF;
    ...
    IF @unapprovedRequestCount < 1 THEN
        ...
        VALUES (profile_id, 1, change_type, current_value, dataValue, NOW(), approved, updated_by, updated_by, tidId, @acquirer);
    END IF;
