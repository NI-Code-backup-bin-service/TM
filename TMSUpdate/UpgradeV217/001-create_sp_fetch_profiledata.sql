--multiline;
CREATE PROCEDURE `profile_data_element_fetch`(IN siteId int, IN dataElementName varchar(255), IN dataGroupName varchar(255))
BEGIN
WITH profileData AS (
    SELECT pd.datavalue, pd.data_element_id,
