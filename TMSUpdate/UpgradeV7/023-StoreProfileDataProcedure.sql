...
BEGIN
    ...
    insert into profile_data (profile_id, data_element_id, datavalue, version, updated_at, updated_by,created_at, created_by, approved)
		values (profile_ident, data_element, datavalue, currentVersion+1, current_timestamp, updated_by, current_timestamp, updated_by, approved);
