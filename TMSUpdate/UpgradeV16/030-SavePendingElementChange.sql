...
BEGIN
    ...
    INSERT INTO approvals(profile_id, data_element_id, change_type, current_value, new_value, created_at, created_by, approved, acquirer)
    VALUES (profile_id,data_element_id,change_type, current_value, dataValue,NOW(),updated_by,0, @acquirer);
END