...
BEGIN
    ...
    ELSE
        INSERT INTO velocity_limits (velocity_limit_id, site_id, tid_id, limit_level, scheme, transaction_limit_daily, transaction_limit_batch, single_transaction_limit, cumulative_daily, cumulative_batch)
        VALUES (
        id,
        siteID,
        tidID,
