--multiline
create procedure add_tid_user(IN p_tidUserId int, IN p_tidId int, IN p_Username varchar(255), IN p_Pin varchar(66), IN p_Modules varchar(512), IN p_Encrypted tinyint(1))
BEGIN
