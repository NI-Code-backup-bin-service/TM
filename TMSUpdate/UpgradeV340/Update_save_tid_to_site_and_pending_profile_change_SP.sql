...
BEGIN
	...
	INSERT INTO tid (tid_id, serial, flag_status,flagged_date, eod_auto, auto_time) VALUES (tidInt, serialNumber, 1, now(), eodAuto, autoTime);
    INSERT INTO tid_site VALUES (tidInt, site, NULL, NOW());
