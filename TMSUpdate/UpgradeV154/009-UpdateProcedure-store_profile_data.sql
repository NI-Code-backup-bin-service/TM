--multiline
CREATE PROCEDURE store_profile_data(IN p_profile_ident int, IN p_data_element int, IN p_datavalue TEXT, IN p_updated_by varchar(255), IN p_approved int, IN p_overriden int, IN p_is_encrypted tinyint(1))
BEGIN
